                  ...
                  try {
                    ...
                    if (isOnLinkedInPage) {
                      if (typeof window !== 'undefined') {
                        ...
                        sessionStorage.setItem('previousPageBeforeGetMeInterview', '/linkedin-profile-optimization-services');
        ...
        <div className={styles.demoSection}>
          ...
          <button 
            ...
            onClick={(e) => {
              ...
              const isLinkedInPage = currentPath === '/linkedin-profile-optimization-services' || currentPath === '/en-ca/linkedin-profile-optimization-services';
